  ...
  <main id="main">
    ...
    <section class="model-marquee" aria-label="Styled by ÉLAN">
      ...
      <div class="model-marquee__track" aria-hidden="true">
        <div class="model-marquee__inner">
          <div class="model-marquee__model"><img class="model-front" src="https://ecommerce-landing.pages.dev/05-elan-moody/assets/elan-model-01.png" alt="" loading="lazy"><img class="model-back" src="https://ecommerce-landing.pages.dev/05-elan-moody/assets/elan-model-01-back.png" alt="" loading="lazy"></div>
          <div class="model-marquee__model"><img class="model-front" src="https://ecommerce-landing.pages.dev/05-elan-moody/assets/elan-model-02.png" alt="" loading="lazy"><img class="model-back" src="https://ecommerce-landing.pages.dev/05-elan-moody/assets/elan-model-02-back.png" alt="" loading="lazy"></div>
          <div class="model-marquee__model"><img class="model-front" src="https://ecommerce-landing.pages.dev/05-elan-moody/assets/elan-model-03.png" alt="" loading="lazy"><img class="model-back" src="https://ecommerce-landing.pages.dev/05-elan-moody/assets/elan-model-03-back.png" alt="" loading="lazy"></div>
          <div class="model-marquee__model"><img class="model-front" src="https://ecommerce-landing.pages.dev/05-elan-moody/assets/elan-model-04.png" alt="" loading="lazy"><img class="model-back" src="https://ecommerce-landing.pages.dev/05-elan-moody/assets/elan-model-04-back.png" alt="" loading="lazy"></div>
          <div class="model-marquee__model"><img class="model-front" src="https://ecommerce-landing.pages.dev/05-elan-moody/assets/elan-model-05.png" alt="" loading="lazy"><img class="model-back" src="https://ecommerce-landing.pages.dev/05-elan-moody/assets/elan-model-05-back.png" alt="" loading="lazy"></div>
          <div class="model-marquee__model"><img class="model-front" src="https://ecommerce-landing.pages.dev/05-elan-moody/assets/elan-model-06.png" alt="" loading="lazy"><img class="model-back" src="https://ecommerce-landing.pages.dev/05-elan-moody/assets/elan-model-06-back.png" alt="" loading="lazy"></div>
          <div class="model-marquee__model"><img class="model-front" src="https://ecommerce-landing.pages.dev/05-elan-moody/assets/elan-model-07.png" alt="" loading="lazy"><img class="model-back" src="https://ecommerce-landing.pages.dev/05-elan-moody/assets/elan-model-07-back.png" alt="" loading="lazy"></div>
          <div class="model-marquee__model"><img class="model-front" src="https://ecommerce-landing.pages.dev/05-elan-moody/assets/elan-model-08.png" alt="" loading="lazy"><img class="model-back" src="https://ecommerce-landing.pages.dev/05-elan-moody/assets/elan-model-08-back.png" alt="" loading="lazy"></div>
          <div class="model-marquee__model"><img class="model-front" src="https://ecommerce-landing.pages.dev/05-elan-moody/assets/elan-model-01.png" alt="" loading="lazy"><img class="model-back" src="https://ecommerce-landing.pages.dev/05-elan-moody/assets/elan-model-01-back.png" alt="" loading="lazy"></div>
          <div class="model-marquee__model"><img class="model-front" src="https://ecommerce-landing.pages.dev/05-elan-moody/assets/elan-model-02.png" alt="" loading="lazy"><img class="model-back" src="https://ecommerce-landing.pages.dev/05-elan-moody/assets/elan-model-02-back.png" alt="" loading="lazy"></div>
          <div class="model-marquee__model"><img class="model-front" src="https://ecommerce-landing.pages.dev/05-elan-moody/assets/elan-model-03.png" alt="" loading="lazy"><img class="model-back" src="https://ecommerce-landing.pages.dev/05-elan-moody/assets/elan-model-03-back.png" alt="" loading="lazy"></div>
          <div class="model-marquee__model"><img class="model-front" src="https://ecommerce-landing.pages.dev/05-elan-moody/assets/elan-model-04.png" alt="" loading="lazy"><img class="model-back" src="https://ecommerce-landing.pages.dev/05-elan-moody/assets/elan-model-04-back.png" alt="" loading="lazy"></div>
    ...
    <section class="collection-section" id="collections" aria-labelledby="collections-title">
      ...
      <div class="collection-scroll" id="collection-scroll">
        <a href="#" class="collection-card"><img src="https://ecommerce-landing.pages.dev/05-elan-moody/assets/elan-cat-jerseys.jpg" alt="Jerseys" loading="lazy"><div class="collection-card__overlay"><span class="collection-card__cta">Shop now</span><span class="collection-card__title">Jerseys</span></div></a>
        <a href="#" class="collection-card"><img src="https://ecommerce-landing.pages.dev/05-elan-moody/assets/elan-cat-training.jpg" alt="Training" loading="lazy"><div class="collection-card__overlay"><span class="collection-card__cta">Shop now</span><span class="collection-card__title">Training</span></div></a>
        <a href="#" class="collection-card"><img src="https://ecommerce-landing.pages.dev/05-elan-moody/assets/elan-cat-accessories.jpg" alt="Accessories" loading="lazy"><div class="collection-card__overlay"><span class="collection-card__cta">Shop now</span><span class="collection-card__title">Accessories</span></div></a>
        <a href="#" class="collection-card"><img src="https://ecommerce-landing.pages.dev/05-elan-moody/assets/elan-cat-lifestyle.jpg" alt="Lifestyle" loading="lazy"><div class="collection-card__overlay"><span class="collection-card__cta">Shop now</span><span class="collection-card__title">Lifestyle</span></div></a>
        <a href="#" class="collection-card"><img src="https://ecommerce-landing.pages.dev/05-elan-moody/assets/elan-cat-national.jpg" alt="National Teams" loading="lazy"><div class="collection-card__overlay"><span class="collection-card__cta">Shop now</span><span class="collection-card__title">National Teams</span></div></a>
        <a href="#" class="collection-card"><img src="https://ecommerce-landing.pages.dev/05-elan-moody/assets/elan-cat-club.jpg" alt="Club Teams" loading="lazy"><div class="collection-card__overlay"><span class="collection-card__cta">Shop now</span><span class="collection-card__title">Club Teams</span></div></a>
      </div>
    </section>
    <section class="new-arrivals" id="shop" aria-labelledby="new-title">
      ...
      <div class="new-arrivals__scroll" id="new-arrivals-scroll">
        <article class="new-arrivals__card reveal"><div class="new-arrivals__image"><img src="https://ecommerce-landing.pages.dev/05-elan-moody/assets/elan-new-01.jpg" alt="Vinta Home Jersey" loading="lazy"></div><div class="new-arrivals__info"><h3>Vinta Home</h3><p class="price">€89,00</p></div></article>
        <article class="new-arrivals__card reveal"><div class="new-arrivals__image"><img src="https://ecommerce-landing.pages.dev/05-elan-moody/assets/elan-new-02.jpg" alt="Marino Home Jersey" loading="lazy"></div><div class="new-arrivals__info"><h3>Marino Home</h3><p class="price">€95,00</p></div></article>
        <article class="new-arrivals__card reveal"><div class="new-arrivals__image"><img src="https://ecommerce-landing.pages.dev/05-elan-moody/assets/elan-new-03.jpg" alt="Fjord Home Jersey" loading="lazy"></div><div class="new-arrivals__info"><h3>Fjord Home</h3><p class="price">€102,00</p></div></article>
        <article class="new-arrivals__card reveal"><div class="new-arrivals__image"><img src="https://ecommerce-landing.pages.dev/05-elan-moody/assets/elan-new-04.jpg" alt="Sovrano Home Jersey" loading="lazy"></div><div class="new-arrivals__info"><h3>Sovrano Home</h3><p class="price">€89,00</p></div></article>
        <article class="new-arrivals__card reveal"><div class="new-arrivals__image"><img src="https://ecommerce-landing.pages.dev/05-elan-moody/assets/elan-new-05.jpg" alt="Nordic Home Jersey" loading="lazy"></div><div class="new-arrivals__info"><h3>Nordic Home</h3><p class="price">€99,00</p></div></article>
        <article class="new-arrivals__card reveal"><div class="new-arrivals__image"><img src="https://ecommerce-landing.pages.dev/05-elan-moody/assets/elan-new-06.jpg" alt="Aurelia Home Jersey" loading="lazy"></div><div class="new-arrivals__info"><h3>Aurelia Home</h3><p class="price">€95,00</p></div></article>
      </div>
    </section>
    <section class="editorial-section" id="exclusives" aria-labelledby="exclusives-title">
      <div class="editorial-image reveal"><img src="https://ecommerce-landing.pages.dev/05-elan-moody/assets/elan-editorial-lifestyle.jpg" alt="Élan exclusive editorial" loading="lazy"></div>
    ...
    <section class="product-section" aria-labelledby="trending-title">
      ...
      <div class="product-grid">
        <article class="product-tile reveal"><div class="product-tile__image"><img src="https://ecommerce-landing.pages.dev/05-elan-moody/assets/elan-product-05.jpg" alt="Nordic Home Jersey" loading="lazy"><button class="wishlist-btn" aria-label="Add to favourites">♡</button></div><div class="product-tile__info"><h3>Nordic Home</h3><p class="price">€98,00</p></div></article>
        <article class="product-tile reveal"><div class="product-tile__image"><img src="https://ecommerce-landing.pages.dev/05-elan-moody/assets/elan-product-07.jpg" alt="Sovrano Home Jersey" loading="lazy"><button class="wishlist-btn" aria-label="Add to favourites">♡</button></div><div class="product-tile__info"><h3>Sovrano Home</h3><p class="price">€110,00</p></div></article>
        <article class="product-tile reveal"><div class="product-tile__image"><img src="https://ecommerce-landing.pages.dev/05-elan-moody/assets/elan-product-04.jpg" alt="Aurelia Home Jersey" loading="lazy"><button class="wishlist-btn" aria-label="Add to favourites">♡</button></div><div class="product-tile__info"><h3>Aurelia Home</h3><p class="price">€102,00</p></div></article>
        <article class="product-tile reveal"><div class="product-tile__image"><img src="https://ecommerce-landing.pages.dev/05-elan-moody/assets/elan-product-08.jpg" alt="Cirrus Home Jersey" loading="lazy"><button class="wishlist-btn" aria-label="Add to favourites">♡</button></div><div class="product-tile__info"><h3>Cirrus Home</h3><p class="price">€95,00</p></div></article>
      </div>
    </section>
  </main>
