Rebuild this hero section 1:1 according to the following exact specifications (extracted from the matching Full LP prompt in full-prompts/quorum.md).
...
- Newsroom/editorial conceit threaded throughout: nav and section names are "The Desk", "Dispatches", "Workflow", "Rates"
- Animation library: not detected — animated count-up stats, progress-bar fill (not used in the hero itself)

=== SECTION: Nav ===
Content (copy verbatim): "Quorum" wordmark · links "The Desk", "Dispatches", "Workflow", "Rates" · button "Start Free — No Card"

=== SECTION: Hero (The Desk) ===
...
- This is the hero section only — do not build out social proof, pricing, or footer.
