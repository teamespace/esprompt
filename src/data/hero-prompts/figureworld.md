Rebuild this hero section 1:1 according to the following exact specifications (extracted from the matching Full LP prompt in full-prompts/figureworld.md — this brand's entire live site is a single-viewport hero, so almost nothing was trimmed).
...
=== SECTION: Hero carousel (single full-bleed viewport) ===
...
- Do not invent additional sections (pricing, testimonials, footer, etc.) — the live site is this single viewport.
